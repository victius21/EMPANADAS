...
class InventarioController {
    ...
    // =========================================================
    // INSERCIÓN DE INSUMOS (sin debug)
    // =========================================================
    public function insumoStore() {
        ...
        try {
            ...
            $_SESSION['flash'] = [
                'exito' => null,
                'error' => 'Error al guardar insumo: ' . $e->getMessage()
            ];
        }
    ...
    // =========================================================
    // MOVIMIENTOS (con proveedor/costo/nota)
    // =========================================================
    public function movimientoStore() {
        ...
        if ($insumo_id <= 0 || $cantidad <= 0 || !in_array($tipo, ['entrada','salida'], true)) {
            $_SESSION['flash'] = [
                'exito' => null,
                'error' => 'Movimiento inválido. Revisa insumo/tipo/cantidad.'
            ];
            header("Location: index.php?action=insumos");
            exit;
        }
        ...
        try {
            ...
            $_SESSION['flash'] = [
                'exito' => null,
                'error' => 'Error al guardar movimiento: ' . $e->getMessage()
            ];
        }
